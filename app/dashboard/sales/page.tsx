...
export default async function SalesPage({ searchParams }: SalesPageProps) {
  ...
  const canCancelSale = hasPermission(user, "cancel_sale");
  ...
  if (!canViewSales) {
    return (
      <div className="text-center py-12">
        <h1 className="text-2xl font-bold mb-4 text-foreground">বিক্রি তালিকা</h1>
        <p className="mb-2 text-danger font-semibold">অ্যাকসেস সীমাবদ্ধ</p>
        <p className="mb-6 text-muted-foreground">
          এই পেজ ব্যবহারের জন্য <code>view_sales</code> permission লাগবে।
        </p>
        <Link
          href="/dashboard"
  ...
  return (
    <div className="space-y-4 sm:space-y-5 section-gap pb-[128px] sm:pb-[110px]">
      ...
      <SalesListClient
        ...
        canVoidSale={canCancelSale}
        canEditDueSale={canCreateSale && canCreateDueSale}
