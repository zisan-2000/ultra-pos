    ...
    <div className="rounded-xl border border-border/70 bg-background px-2.5 py-2 space-y-1.5">
      ...
      <div className="flex items-center gap-1.5">
        ...
        <input
          ...
          onFocus={(e) => e.target.select()}
          readOnly={serialized}
          className="h-7 w-12 rounded-lg border border-border bg-card px-1 text-center text-xs font-semibold text-foreground outline-none focus:border-primary/40 focus:ring-1 focus:ring-primary/20 read-only:bg-muted/40"
        />
        <button
          type="button"
